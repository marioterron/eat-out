	angular.module('eatApp')
		.factory('foursquareService', function($http) {
			...
			function _getVenues(query, location) {
				var url = 'https://api.foursquare.com/v2/venues/search?v=20170501&radius=4500&near=' + location + '&query=' + query + '&categoryId=4d4b7105d754a06374d81259&client_id=IXSMMTKC1C0EOWTOMSINDGHJLA12LXXLVIBH3J4DSKL5I3VW&client_secret=WK55K10UKPAJVGZKFI1XNCORVSKRYRLLWKFQ4TDO2U01AR2V'
				return $http.get(url)
